...
CREATE TABLE mf_rolling_return_stats
(
    id             BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    ...
    CONSTRAINT pk_mf_rolling_return_stats PRIMARY KEY (id)
);
...
ALTER TABLE mf_rolling_return_stats
    ADD CONSTRAINT FK_MF_ROLLING_RETURN_STATS_ON_SCHEME FOREIGN KEY (scheme_id) REFERENCES mf_scheme_details (id);
